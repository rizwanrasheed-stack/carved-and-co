  ...
  return (
    <section id="craftsmanship-section" className="py-20 sm:py-28 bg-[#F4EEE4] text-[#24201E] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* EDITORIAL BANNER */}
        <div className="relative rounded-2xl overflow-hidden shadow-2xl mb-14 sm:mb-16 border border-[#35171B]/15">
          <img
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#35171B]/95 via-[#35171B]/65 to-transparent" />
          
          <div className="absolute inset-0 p-6 sm:p-12 lg:p-16 flex flex-col justify-center max-w-2xl text-white">
            <span className="text-[11px] sm:text-xs font-serif tracking-[0.3em] uppercase text-[#B89458] mb-3 font-semibold">
              Editorial Atelier Showcase
            </span>
            <svg className="w-16 h-2 text-[#B89458] mb-4" viewBox="0 0 80 8" fill="none">
              <path d="M 0 4 Q 20 0, 40 4 T 80 4" stroke="#B89458" strokeWidth="1.5" strokeLinecap="round" />
            </svg>
            <h2 className="font-serif text-3xl sm:text-5xl lg:text-6xl font-normal leading-tight mb-4 sm:mb-6 text-[#F4EEE4]">
              Crafted by Skilled Hands
            </h2>
            <p className="text-xs sm:text-sm lg:text-base text-[#F4EEE4]/90 font-light leading-relaxed mb-6 sm:mb-8">
            ...
            <div>
              <span className="inline-block px-4 sm:px-5 py-2 sm:py-2.5 border border-[#B89458] text-[#B89458] text-[10px] sm:text-xs font-serif uppercase tracking-widest rounded-full bg-[#35171B]/60 backdrop-blur-sm font-semibold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 text-left">
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-[#EDE3D5]/60 border border-[#35171B]/10 space-y-3 sm:space-y-4 shadow-xs">
