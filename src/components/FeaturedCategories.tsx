    ...
    <section id="featured-categories-section" className="py-16 sm:py-20 bg-[#EDE3D5] text-[#24201E] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div 
          ...
          className="flex flex-col md:flex-row md:items-end justify-between mb-10 sm:mb-12 border-b border-[#35171B]/10 pb-6"
        >
          <div>
          ...
          <p className="text-xs sm:text-sm text-[#24201E]/80 font-light max-w-md mt-4 md:mt-0 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <motion.div 
            ...
            className="group relative h-[420px] sm:h-[500px] rounded-2xl overflow-hidden cursor-pointer shadow-xl hover:shadow-2xl transition-all duration-500 border border-[#35171B]/15 hover:border-[#B89458] min-w-0"
          >
            ...
            <div className="absolute inset-0 p-5 sm:p-8 flex flex-col justify-between text-white z-10">
              <div className="flex justify-between items-start">
                <span className="bg-[#4A1F24]/95 border border-[#B89458]/50 text-[#B89458] text-[9.5px] xs:text-[10px] font-serif uppercase tracking-[0.16em] sm:tracking-[0.2em] px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full backdrop-blur-sm font-semibold">
                  Catalog • 27 Designs
                </span>
                <span className="text-xl sm:text-2xl font-serif text-[#B89458] font-light">01</span>
              </div>

              <div>
                <div className="flex items-center gap-2 mb-2">
                  <Armchair className="w-4 h-4 text-[#B89458]" />
                  <span className="text-[10px] sm:text-[11px] font-serif text-[#B89458] uppercase tracking-[0.2em] sm:tracking-[0.25em]">
                    Living Room Suite
                  </span>
                </div>
          ...
          >
            ...
            <div className="absolute inset-0 p-5 sm:p-8 flex flex-col justify-between text-white z-10">
              <div className="flex justify-between items-start">
                ...
                <span className="text-xl sm:text-2xl font-serif text-[#B89458] font-light">02</span>
              </div>
          ...
          >
            ...
            <div className="absolute inset-0 p-5 sm:p-8 flex flex-col justify-between text-white z-10">
              <div className="flex justify-between items-start">
                <span className="bg-[#B89458] text-[#35171B] text-[9.5px] xs:text-[10px] font-serif uppercase tracking-[0.16em] sm:tracking-[0.2em] px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full font-bold shadow-sm">
                  Tailored To Order
                </span>
                <span className="text-xl sm:text-2xl font-serif text-[#B89458] font-light">03</span>
              </div>
